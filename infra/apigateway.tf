...
resource "aws_api_gateway_method" "recipes_api_any_method" {
  rest_api_id   = aws_api_gateway_rest_api.recipes_rest_api.id
...
resource "aws_api_gateway_integration" "lambda_any_integration" {
  rest_api_id             = aws_api_gateway_rest_api.recipes_rest_api.id
  resource_id             = aws_api_gateway_resource.recipes_resource.id
  http_method             = aws_api_gateway_method.recipes_api_any_method.http_method
...
resource "aws_api_gateway_deployment" "recipes_api_deployment" {
  depends_on = [
    aws_api_gateway_integration.lambda_any_integration
...
# resource "aws_api_gateway_stage" "recipes_api_stage" {
#   deployment_id = aws_api_gateway_deployment.recipes_api_deployment.id
#   rest_api_id   = aws_api_gateway_rest_api.recipes_rest_api.id
#   stage_name    = var.api_gw_stage_name
...
# resource "aws_api_gateway_method_settings" "recipes_api_method_settings" {
#   rest_api_id = aws_api_gateway_rest_api.recipes_rest_api.id
#   stage_name  = aws_api_gateway_stage.recipes_api_stage.stage_name
#   method_path = "*/*"
...
# resource "aws_cloudwatch_log_group" "recipes_api_gw_logs" {
#   name              = "API-Gateway-Execution-Logs_${aws_api_gateway_rest_api.recipes_api_deployment.id}/${var.stage_name}"
#   retention_in_days = 7
# }
...
output "api_gateway_url" {
  value = aws_api_gateway_deployment.recipes_api_deployment.invoke_url
}
