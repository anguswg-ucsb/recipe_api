...
from lambda_containers.extract_ingredients._constants import (
    AMBIGUOUS_UNITS,
...
from lambda_containers.extract_ingredients.ingredient_parser.funcs import stem, tokenize
from lambda_containers.extract_ingredients.ingredient_parser.regex import (
    CAPITALISED_PATTERN,
...
PreProcessor("2 cups (500 ml) milk")